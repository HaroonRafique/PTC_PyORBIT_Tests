...
f.write('\n')
f.write('\n# Run the job')
if hyperthreading:f.write('\n${ORBIT_ROOT}/../bin/mpirun ${ORBIT_ROOT}/bin/pyORBIT ${RUN_DIR}/' + str(simulation_file))	
# ~ if hyperthreading:f.write('\n/home/vol05/scarf1015/apps20_ptc-pyorbit/PTC-PyORBIT/Merged_HR_PyORBIT_2/bin/mpirun ${ORBIT_ROOT}/bin/pyORBIT ${RUN_DIR}/' + str(simulation_file))	

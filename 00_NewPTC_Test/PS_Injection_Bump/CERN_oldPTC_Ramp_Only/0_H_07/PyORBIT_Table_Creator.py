...
# Haroon Rafique STFC ISIS Accelerator Division 23.06.21 Python 3 update
#
import numpy as np
import os
import sys
...
# ~ B_40 = Read_Double_Column_TFS_Return_Data('./MADX_Tables/BSEXT40.tfs', f1=1./l_bsw, f2=1./l_bsw)
B_40 = Read_Double_Column_TFS_Return_Data('./MADX_Tables/BSEXT40.tfs', f1=1./l_bsw, f2=sextupole_off)
...
# ~ B_42 = Read_Double_Column_TFS_Return_Data('./MADX_Tables/BSEXT42.tfs', f1=1./l_bsw, f2=1./l_bsw)
B_42 = Read_Double_Column_TFS_Return_Data('./MADX_Tables/BSEXT42.tfs', f1=1./l_bsw, f2=sextupole_off)
...
# ~ B_43 = Read_Double_Column_TFS_Return_Data('./MADX_Tables/BSEXT43.tfs', f1=1./l_bsw, f2=1./l_bsw)
B_43 = Read_Double_Column_TFS_Return_Data('./MADX_Tables/BSEXT43.tfs', f1=1./l_bsw, f2=sextupole_off)
...
# ~ B_44 = Read_Double_Column_TFS_Return_Data('./MADX_Tables/BSEXT44.tfs', f1=1./l_bsw, f2=1./l_bsw)
B_44 = Read_Double_Column_TFS_Return_Data('./MADX_Tables/BSEXT44.tfs', f1=1./l_bsw, f2=sextupole_off)
